...
/**
 * Cette classe existe également dans Java 1.5 mais avec un code qui ne permet pas de retrouver
 * correctement les URL de type file: il y a un slash de trop !!!
 *
 * Il faut donc mettre ce work-around pour pouvoir utiliser les catalogue donné dans
 * ech-catalog.xml.
 *
 * P.Meigniez
 */
